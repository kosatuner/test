...
class IndicatorsControllerTest < ActionController::TestCase
  ...
  test "should create indicator" do
    assert_difference('Indicator.count') do
      post :create, indicator: { fecha: @indicator.fecha, indicatortype_id: @indicator.indicatortype_id, signal: @indicator.signal, stock_id: @indicator.stock_id, valor: @indicator.valor }
    end
  ...
  test "should update indicator" do
    patch :update, id: @indicator, indicator: { fecha: @indicator.fecha, indicatortype_id: @indicator.indicatortype_id, signal: @indicator.signal, stock_id: @indicator.stock_id, valor: @indicator.valor }
    assert_redirected_to indicator_path(assigns(:indicator))
  end
